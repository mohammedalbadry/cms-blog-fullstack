		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-10 col-lg-8 p-b-80">
					<div class="row">
                        ...
                        @foreach($category_posts as $post)
                            <div class="col-sm-6 p-r-25 p-r-15-sr991">
                                <!-- Item latest -->	
                                <div class="m-b-45">
                                    <a href="{{url('/' . $post->slug)}}" class="wrap-pic-w hov1 trans-03 new-size">
					...
					<!-- Pagination -->
					{{ $category_posts->appends(request()->query())->links('enduser.partials.pagination') }}
				</div>
