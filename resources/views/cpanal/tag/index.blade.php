          ...
          <div class="card card-outline table-responsive card-info">
            <!-- /.card-header -->
              <div class="card-header">
                <div class="row">
                  <div class="col-md-5">
                    <form action="{{aurl('tags')}}" method="get">
                  ...
                  <div class="col-md-4">
                    <a href="{{aurl('tags/create')}}" class="btn btn-info">اضف <i class="fa fa-plus"></i></a>
                  </div>
                </div>
              </div>
              <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($data as $index=>$model)
                          <tr>
                            ...
                            <td>
                              <a  class="btn btn-primary btn-sm" href="{{aurl('tags/'. $model->id .'/edit')}}">تعديل <i class="fa fa-edit"></i></a>
                                ...
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-footer justify-content-between">
                                      <form method="post" action="{{aurl("tags/".$model->id)}}">
                                        @csrf
                                        @method('delete')
                ...
                @else
                  <h3 class="alert alert-primary text-center">لا يوجد وسوم</h3>
                @endif
              </div>
