...
<link rel="stylesheet" href="{{asset('cpanal/plugins/fontawesome-free/css/all.min.css')}}">
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="{{asset('cpanal/plugins/icheck-bootstrap/icheck-bootstrap.min.css')}}">
  <!-- Theme style -->
...
<div class="login-box">
  <div class="login-logo">
    <a href="{{aurl()}}">{{$setting->name}}</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">تعين كلمه سر جديده</p>
...
@include('cpanal.partials.message')
    ...
    <form method="post">
      @csrf
        ...
        <input type="email" name="email" value="{{$data->email}}" class="form-control" placeholder="البريد الاكترونى">
        ...
        <div class="input-group mb-3">
            <input type="password" name="password_confirmation" class="form-control" placeholder="اعد كتابه كلمه السر">
            <div class="input-group-append">
              <div class="input-group-text">
                <span class="fas fa-lock"></span>
              </div>
