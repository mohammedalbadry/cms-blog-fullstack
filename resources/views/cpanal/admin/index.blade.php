          ...
          <div class="card card-outline table-responsive card-info">
            <!-- /.card-header -->
              <div class="card-header">
                <div class="row">
                  <div class="col-md-5">
                    <form action="{{aurl('admins')}}" method="get">
                  ...
                  <div class="col-md-4">
                    <a href="{{aurl('admins/create')}}" class="btn btn-info">اضف <i class="fa fa-plus"></i></a>
                  </div>
                </div>
              </div>
              <div class="card-body">
                  ...
                  <table class="table table-bordered">
                    <thead>                  
                      <tr>
                        ...
                        <th  class="d-none d-sm-block">الصفة</th>
                        <th>الأجراءات</th>
                      </tr>
                    </thead>
                    <tbody>
                        @foreach ($data as $index=>$model)
                          <tr>
                            ...
                            <td>{{$model->email}}</</td>
                            <td class="d-none d-sm-block">{{ $model->roles->first()->display_name }}</</td>
                            <td>
                              <a  class="btn btn-primary btn-sm" href="{{aurl('admins/'. $model->id .'/edit')}}">تعديل <i class="fa fa-edit"></i></a>
                                ...
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-footer justify-content-between">
                                      <form method="post" action="{{aurl("admins/".$model->id)}}">
                                        @csrf
                                        @method('delete')
                ...
                @else
                  <h3 class="alert alert-primary text-center">لا يوجد مشرفين</h3>
                @endif
              </div>
